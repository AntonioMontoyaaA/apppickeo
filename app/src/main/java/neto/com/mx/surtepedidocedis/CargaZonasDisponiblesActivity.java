...
public class CargaZonasDisponiblesActivity extends AppCompatActivity {
    ...
    private static final int ZONA_PERMITIDA         =   1;
    private static final int ZONA_INICIADA          =   0;
    ...
    public void dibujaZonas() {
        ...
        for(int i = 0; i < listaZonas.size(); i++) {
            /*for (int j = 0; j< listaZonas.size(); j++){
                ...
                System.out.println("//////////////////// " + listaZonas.get(j).getDescripcionZona() +" ////////////");

                System.out.println("///////////Prueba 2///////// " + listaZonas.get(j).getNombreCorto() + " ////////////");
            }*/
            switch(i) {
                case 0:
                    ...
                    if(listaZonas.get(i).getZonaValida() == ZONA_PERMITIDA) {
                        //btn.setEnabled(true);
                        btn.setAlpha(1f);
                    }
    ...
    public void iniciaConteo(View view) {
        ...
        if(listaZonas.get(tag - 1).getZonaValida() == ZONA_PERMITIDA || listaZonas.get(tag - 1).getZonaValida() == ZONA_FINALIZADA) {
        ...
        } else if(listaZonas.get(tag - 1).getZonaValida() == ZONA_INICIADA) {
            String mensaje = "Esta zona se está pickeando por: " + listaZonas.get(tag - 1).getNombreUsuario();
